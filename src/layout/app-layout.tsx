...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['clinic-owner', 'clinic-administrator', 'clinic-staff', 'medical-professional'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Document', path: '/documents', entity: 'document', service: AccessServiceEnum.PROJECT, icon: FiFile },
