...
import { getPatientQuestionnaireById } from 'apiSdk/patient-questionnaires';
...
function PatientQuestionnaireViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Patient Questionnaire Detail View
          </Text>
          {hasAccess('patient_questionnaire', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/patient-questionnaires/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              ...
              {hasAccess('questionnaire', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/questionnaires/view/${data?.questionnaire?.id}`}>
