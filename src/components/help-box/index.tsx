...
7. As a Patient, I want to fill out questionnaires so that my medical data can be collected and analyzed by the clinic.

8. As a Clinic Staff, I want to upload and send documents to patients so that they can access important medical information.

9. As a Patient, I want to upload documents so that the clinic can access my medical records and other relevant information.

10. As a Clinic Administrator, I want to transfer questionnaire data to the internal medical record system so that it can be stored and analyzed.`;
